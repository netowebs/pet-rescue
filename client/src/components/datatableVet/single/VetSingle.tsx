...
export const VetSingle = () => {
    ...
    const handleDelete = async () => {
        if (idCad) {
            const res = await vet.deleteVet(idCad)
            if (res.success) {
    ...
    const handleUpdate = async () => {
        const data: any = { idCad, name, cpf, rg, nasc, sex, phone, crmv, speciality, cep, street, num, complement, district, city, state }

        const res = await vet.updateVet(data)
        if (res.success) {
            swal(res.message, " ", "success",)
                .then(() => {
                    window.location.href = '/vets'
    ...
    return (
        <div className='container--vet-new'>
